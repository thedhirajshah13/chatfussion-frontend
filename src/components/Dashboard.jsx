...
const Dashboard = () => {
  ...
  return (
    ...
    >
      {/* Left Sidebar */}
      <div className="w-[30%] flex flex-col justify-between h-[90vh] ml-[2%] rounded-xl border-2 border-gray-800 bg-black/30 backdrop-blur-md shadow-lg p-4">
        {/* Header */}
        ...
        {/* Search Result */}
        {searchResult && (
          <div className="absolute top-[90px] left-6 w-[260px] rounded-xl border-2 border-gray-700 bg-black/50 backdrop-blur-md shadow-lg p-3 z-50">
            <div
